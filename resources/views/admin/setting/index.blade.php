  ...
  <section class="content-header">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin/setting/create')}}">أضافة اعدادات جديدة</a></li>        
      </ol>
    </section>
          ...
          <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th class="text-center"> Another Phone</th>
                  <th class="text-center"> Email</th>
                  <th class="text-center"> Another Email</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"> {{ $data->otherPhone}}</td>
                <td class="text-center"> {{ $data->email}}</td>
                <td class="text-center"> {{ $data->otherEmail}}</td>
                ...
                <td class="text-center">
                 <a href="{{url('admin/setting/'.$data->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a>
               </td>
                <td class="text-center">
                  <form method="post" action="{{url('admin/setting/'.$data->id)}}">
                  {{csrf_field()}}
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <h3 class="text-center ">
                           Do You Want to Delete  :  {{ $data->email }} ? </h3>
                      </div>
