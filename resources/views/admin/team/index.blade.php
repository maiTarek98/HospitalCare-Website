  ...
  <section class="content-header">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin/team/create')}}"> Add new Doctor</a></li>        
      </ol>
    </section>
          ...
          <div class="box-body">
             <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th class="text-center"> Facebook Account  </th>
                  <th class="text-center">Twitter Account    </th>
                  <th class="text-center">LinkedIn Account    </th>
            ...
            <tbody>
              ...
              <tr>
                ...
                @if($data->image)
                 <img class="img-responsive" style="width:100px;height:70px;" src="/Hospital/images/{{ $data->image }}" alt="type of hagama">
            @endif</td>
                <td class="text-center"> {{ $data->created_at }}</td>
                <td class="text-center"> {{ $data->updated_at }}</td>
               
                <td class="text-center">
                 <a href="{{url('admin/team/'.$data->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a>
               </td>
                <td class="text-center">
                  <form method="post" action="{{url('admin/team/'.$data->id)}}">
                  {{csrf_field()}}
