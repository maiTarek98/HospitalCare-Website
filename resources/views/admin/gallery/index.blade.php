  ...
  <section class="content-header">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin/gallery/create')}}">Add new photo</a></li>        
      </ol>
    </section>
          ...
          <div class="box-body">
            ...
            <tbody>
              ...
              <tr>
                ...
                @if($data->photo)
                 <img class="img-responsive" style="width:100px;height:70px;" src="/Hospital/images/{{ $data->photo }}" alt="type of hagama">
            @endif</td>
            <td class="text-center">{{$data->type}}</td>
                ...
                <td class="text-center">
                 <a href="{{url('admin/gallery/'.$data->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a>
               </td>
                <td class="text-center">
                  <form method="post" action="{{url('admin/gallery/'.$data->id)}}">
                  {{csrf_field()}}
