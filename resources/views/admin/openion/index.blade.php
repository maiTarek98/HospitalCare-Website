  ...
  <section class="content-header">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin/openion/create')}}">Add new openion</a></li>        
      </ol>
    </section>
          ...
          <div class="box-body">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center"> {{ $data->patientName }}</td>
            ...
            <td class="text-center"> {{ $data->country }}</td>
                ...
                <td class="text-center">
                 <a href="{{url('admin/openion/'.$data->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a>
               </td>
                <td class="text-center">
                  <form method="post" action="{{url('admin/openion/'.$data->id)}}">
                  {{csrf_field()}}
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <h3 class="text-center ">
                           Do You Want to Delete  :  {{ $data->patientName }} ? </h3>
                      </div>
