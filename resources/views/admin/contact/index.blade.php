  ...
  <section class="content-header">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin/contact/create')}}">Add new contact</a></li>        
      </ol>
    </section>
             ...
             <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th class="text-center"> Informaion</th>
                  <th class="text-center"> Icon</th>
                  <th class="text-center"> Another Info.</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                 <a href="{{url('admin/contact/'.$data->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a>
               </td>
                <td class="text-center">
