    ...
    <section class="content">
        ...
        <div class="col-xs-12">
         <div class="box">
          ...
          <!-- /.box-header -->
           <div class="box-body">
            <!-- form start -->
            <form method="post" action="{{url('admin/opening/'.$user->id)}}">
      ...
      <div class="form-group @if($errors->has('week')) has-error @endif">
           ...
           <div class="form-group @if($errors->has('from')) has-error @endif">
              ...
              <div class="col-md-10">
              <input type="text" class="form-control" name="from" value="{{$user->from}}" placeholder=" from  ">
           ...
           <div class="form-group @if($errors->has('to')) has-error @endif">
              ...
              <div class="col-md-10">
              <input type="text" class="form-control" name="to" value="{{$user->to}}" placeholder=" to  ">
