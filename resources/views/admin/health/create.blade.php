...
<!-- DataTables -->
   <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>Add New health </h1>
      <ol class="breadcrumb">
        <li><a href="{{Url('admin/index')}}"><i class="fa fa-dashboard"></i> Home </a></li>
        <li><a href="{{Url('admin/health')}}">Control of health </a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
         <div class="box">
          ...
          <!-- /.box-header -->
           <div class="box-body">
            <!-- form start -->
        <form action="{{url('admin/health')}}"  method="post" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
           ...
           <div class="form-group @if($errors->has('icon')) has-error @endif">
              <label for="inputEmail3" class="col-md-2 control-label"> icon Photo</label>
              <div class="col-md-10">
