  ...
  <section class="content-header">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{Url('admin/chosen/create')}}">Add new feature</a></li>        
      </ol>
    </section>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                 <a href="{{url('admin/chosen/'.$data->id.'/edit')}}" class="btn btn-primary fa fa-pencil-square-o" ></a>
               </td>
                <td class="text-center">
                  <form method="post" action="{{url('admin/chosen/'.$data->id)}}">
                  {{csrf_field()}}
